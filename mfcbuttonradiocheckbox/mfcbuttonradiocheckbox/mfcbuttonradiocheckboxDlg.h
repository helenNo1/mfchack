...
// mfcbuttonradiocheckboxDlg.h: 头文件
//
...
class CmfcbuttonradiocheckboxDlg : public CDialogEx
{
// 构造
public:
	void CmfcbuttonradiocheckboxDlg::InitAllCheckBoxStatus();
	CmfcbuttonradiocheckboxDlg(CWnd* pParent = nullptr);	// 标准构造函数

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_MFCBUTTONRADIOCHECKBOX_DIALOG };
#endif
